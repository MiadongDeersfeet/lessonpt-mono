...
public class StudentAccessSessionService {
    ...
    public IssuedStudentSession openAfterOtp(Long teacherStudentAccessId) {
        ...
        StudentAccessSession created = newSession(teacherStudentAccessId, rawToken, now);
        try {
    ...
    public void logout(String rawToken) {
        ...
        LocalDateTime now = LocalDateTime.now(clock);
        studentAccessSessionMapper.revokeActiveByAccessId(session.getTeacherStudentAccessId(), now, now);
    }
    ...
    private StudentAccessSession newSession(Long accessId, String rawToken, LocalDateTime now) {
